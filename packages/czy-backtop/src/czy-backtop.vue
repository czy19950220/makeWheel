<template>
  <div :style="{opacity:show ? '1' : '0'}" @click="backTop" class="czy-backtop">
    <div class="czy-backtop-customize-content">
      <slot></slot>
    </div>
    <div class="czy-backtop-content" v-if="!slotShow">
      <div>
        <i class="czyi czy-vertical-align-top"></i>
      </div>
    </div>
  </div>
</template>
