...
/*为便于后期直接摘出某一个，暂时这样写*/
  ...
  *:after {
  ...
  .btn-1:before {
    ...
    border-bottom: 80px solid #1c5569;
    -webkit-transform: translateX(-100%);
    transform: translateX(-100%);
  }
  .btn-1:hover {
  ...
  .btn-1-2:before, .btn-1-2:after {
    ...
    bottom: 0;
    left: 0;
    border-bottom: 80px solid #2b2b56;
  }
  .btn-1-2:before {
    right: -50px;
    border-right: 50px solid transparent;
  ...
  .btn-2:before {
    right: -50px;
    border-right: 50px solid transparent;
    border-bottom: 80px solid #711516;
    -webkit-transform: translateX(-100%);
    transform: translateX(-100%);
  }
  .btn-2:after {
  ...
  .btn-3:before, .btn-3:after {
    ...
    bottom: 0;
    left: 0;
    border-top: 40px solid #434009;
    border-bottom: 40px solid #434009;
  }
  .btn-3:before {
  ...
  .btn-5:after {
    ...
    border-color: transparent #595d1c transparent transparent;
    position: absolute;
    top: 0;
    right: 0;
  }
  .btn-5:before {
    ...
    border-style: solid;
    border-width: 0 0 0 0;
    border-color: transparent transparent transparent #595d1c;
    position: absolute;
    bottom: 0;
    left: 0;
  }
  ...
  .btn-9 span:after {
    ...
    width: 100%;
    height: 0;
    background-color: rgba(22, 94, 65, 0.25);
  ...
  .btn-10 span:after {
    ...
    width: 0;
    height: 80px;
    background-color: rgba(25, 11, 52, 0.25);
    transition: 0.4s;
  }
  .btn-10:after,
  .btn-10 span:before {
