<template>
  <div class="content-box">
    ...
    <p class="demo-introduction">
      github代码仓库地址
      <a href="https://github.com/czy19950220/makeWheel" target="_blank">
        <img
                alt
                class="github-img"
                href="https://github.com/czy19950220/makeWheel"
                src="https://img.shields.io/github/stars/czy19950220/makeWheel.svg?style=social&amp;label=Star&amp;maxAge=2592000"
        />
      </a>
      点个star支持一下吧~
    </p>
    ...
    <p class="demo-introduction">
      <a
              href="https://www.npmjs.com/package/czy-ui"
              target="_blank"
      >https://www.npmjs.com/package/czy-ui</a>
    </p>
    <div class="demo-code-block">npm i czy-ui -S</div>

    <!-- 快速上手 -->
    <h3 class="demo-table-title">快速上手</h3>
    <p class="demo-introduction">你可以在 main.js 中引入整个 czy-ui。</p>
    <div class="demo-code-block">
      <p>import czyUI from 'czy-ui'</p>
      <p style="margin-top:20px">Vue.use(czyUI);</p>
    </div>
    ...
    <p class="demo-introduction">至此，一个基于 Vue 安装了 czy-ui插件 的开发环境已经搭建完毕。各个组件的使用方法请参阅它们各自的文档。</p>
  </div>
</template>
